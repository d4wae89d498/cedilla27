...
echo "____________TEST 3 [test/column.c]______\n"
./../../compiler -E --EXTS="../position/ext.so ./ext.so" test/column.c > test/column_tmp.c && cc ../../lib/ft/libft.a test/column_tmp.c &&  ./a.out

echo "____________TEST 4 [test/define.c]______\n"
